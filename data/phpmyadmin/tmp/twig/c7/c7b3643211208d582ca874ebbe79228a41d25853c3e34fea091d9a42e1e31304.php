...
class __TwigTemplate_72e2ab5f71b23c33df714ba91d8a295a15f00855eac5d3a9a2f978cb44b458a1 extends Twig_Template
{
...
($context["one_key"] ?? null), "constraint", array(), "array")) . ";"));
        ...
        if ($this->getAttribute(($context["one_key"] ?? null), "constraint", array(), "array", true, true)) {
            ...
            // line 31
            echo "            ";
            echo PhpMyAdmin\Util::linkOrButton(($context["drop_url"] ?? null), ($context["drop_str"] ?? null), array("class" => "drop_foreign_key_anchor ajax"));
            echo "
        ";
        }
        // line 33
    ...
    <td>
        ...
        // line 44
        echo "            ";
        $context["on_delete"] = (($this->getAttribute(($context["one_key"] ?? null), "on_delete", array(), "array", true, true)) ? ($this->getAttribute(        // line 45
($context["one_key"] ?? null), "on_delete", array(), "array")) : ("RESTRICT"));
        // line 46
        echo "            ";
        $context["on_update"] = (($this->getAttribute(($context["one_key"] ?? null), "on_update", array(), "array", true, true)) ? ($this->getAttribute(        // line 47
...
";
    ...
    {
        return new Twig_Source("", "table/relation/foreign_key_row.twig", "G:\\server\\data\\phpmyadmin\\templates\\table\\relation\\foreign_key_row.twig");
    }
}
